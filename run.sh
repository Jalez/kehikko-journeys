...
#     with 7840 written here and again in `register.ts` — 7820 through 7960
...
#     while nothing handled a collision. `serves()` handles it: a free 7840 is
...
# did not decide to be framed at 7840 in particular, and a registration still
